...
\jtitle[DAGパス幅に基づくアルゴリズム及びDAG木幅の提案]%	% 和文題目（内容梗概／目次用）
	{DAGパス幅に基づくアルゴリズム\\及びDAG木幅の提案}	% 和文題目
\etitle{algorithms using DAG-pathwidth and proposal of DAG-treewidth}	% 英文題目
\jauthor{伊豆 真哉}				% 和文著者名
