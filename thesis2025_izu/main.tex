...
\begin{proof}
    まず$G'$が常に連結であることを示す．トークンの配置や置き換えの操作は$\mathsf{GrowTokenTree}$の列2か，$\mathsf{FindEmbedding}$の列6，8に限られ，前者は明らかに連結になるようにトークンを配置しており，後者は$T$の削除後，直ちに$T$の子孫すべてを1つずつ上の世代のトークンに置き換えることで連結になるように置き換えている．よって$G'$が常に連結は常に連結である．
